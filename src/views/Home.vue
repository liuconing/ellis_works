    ...
    <div id="Home" class="container-fluid clearfix">
      ...
      <div class="row">
        ...
        <div class="col-md-6 MyInt">
          ...
          <p class="mt-3">
            曾任 思偉達創新科技
            擔任前端工程師職務，在任內為公司建置去中心化交易所前端版面與辜能串接、也製作與智能合約做串接的應用頁面。
          </p>
          <p class="mt-3">
      ...
      <div class="container-fluid GalleryList">
        <ul>
          ...
          <li>
            ...
            <p>
              ● 使用 Vue 框架做撰寫<br />
              ● 使用 Vue transition 與 CSS 動畫切換效果<br />
              ● 使用 Vue v-if 判斷是否渲染該畫面<br />
            </p>
          ...
          <li>
            ...
            <p>
              ● 使用 Vue 框架做撰寫<br />
              ● 使用 Leaflet 地圖繪製工具<br />
              ● 使用 OpenStreetMap 做地圖渲染<br />
              ● axios 取的 API 並渲染出來
            </p>
