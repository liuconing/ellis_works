...
import AirQuality from "./Gallerys/AirQuality/AirQuality.vue";
import Fortune from "./Gallerys/Fortune/Fortune.vue";
import Tourism from "./Gallerys/Tourism/Tourism.vue";
